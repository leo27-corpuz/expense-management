        ...
        <template v-else>
            ...
            <div class="form-container">
                <form @submit.prevent="submit">
                    <titleformComponent title="Update Category Form"></titleformComponent>
    ...
    methods: {
        async submit(){
            ...
            try {
                ...
                const response = await axiosIntance.post(`/api/admin/category/update/${this.$route.params.id}`, formData, config)
        ...
        async getCategoryData(){
            try {
                ...
                const response = await axiosIntance.get(`/api/admin/category/update/${this.$route.params.id}`, config)
