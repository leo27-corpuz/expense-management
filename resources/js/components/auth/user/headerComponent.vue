            ...
            <div class="admin-info">
               ...
               <transition name="slide-top-fade" v-show="settingStatus" @click="handleClick">
                    <ul class="dropdown"  ref="targetV2">
                        <router-link :to="{name: 'profileuser'}"><li><i class="fa-regular fa-user"></i> <p>Profile</p></li></router-link>
    ...
    methods: {
        ...
        async logout(){
            try {
                ...
                const response = await axiosIntance.get('/api/user/auth/logout', config)
