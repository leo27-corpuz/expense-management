<template>
    <article>
        ...
        <template v-else>
            <div class="back">
                <router-link :to="{ name: 'profileuser' }"><button><i class="fa-solid fa-angle-left"></i>
    ...
    methods: {
        async submit(){
            ...
            try {
                ...
                const response = await axiosIntance.post(`/api/user/auth/update/password`, formData, config)
